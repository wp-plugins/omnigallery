...
<div id="sc_options" class="wrap <?php if (get_bloginfo('text_direction') == 'rtl') { echo 'rtl'; } ?> sc_instagram">
	...
	<div class="one_col sc_container">
        ...
        <?php if($isPHP5): ?>
          ...
          <div class="group c1" id="sc-option-intaaccsettings">
            ...
            <?php else: ?>
              ...
              <p><input type="submit" class="button" name="scinstagram-update-auth-settings" value="<?php _e('Save settings', 'omnigallery'); ?>" /></p>
            <?php endif;?>
              ...
              <tbody>
                <tr valign="top">
                  ...
                  <?php else: // Cache inactive ?>
                    <td><?php _e('Cache is not active', 'omnigallery'); ?></td>
                  <?php endif; ?>
                </tr>
